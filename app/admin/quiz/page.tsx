      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-8 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
            ...
            { label: "Module mit Quiz", value: `${modulesWithQuiz}/22` },
            { label: "Ø Score",         value: avgScore ? `${avgScore}%` : "–" },
          ].map((kpi) => (
            <div key={kpi.label} className="bg-white border border-line p-4">
        ...
        <section>
          ...
          <div className="bg-white border border-line overflow-hidden">
            <div className="overflow-x-auto">
              <div className="grid grid-cols-[70px_minmax(120px,1fr)_56px_64px_120px_120px] min-w-[580px] bg-primary text-white font-mono text-[10px] uppercase tracking-[0.08em]">
              ...
              {allModules.map((m, i) => {
                ...
                return (
                  <div
                    key={m.id}
                    className={`grid grid-cols-[70px_minmax(120px,1fr)_56px_64px_120px_120px] min-w-[580px] border-t border-line items-center ${i % 2 === 0 ? "bg-white" : "bg-bg-2"}`}
                  >
