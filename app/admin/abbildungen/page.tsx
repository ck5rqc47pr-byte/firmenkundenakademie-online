...
const GRAFIKEN_MAP: Record<string, Array<{ bezeichnung: string; datei: string }>> = {
  ...
  M26: [
    { bezeichnung: "Wirkungskette ESG-Ereignis bis Rating/PD", datei: "/grafiken/M26-wirkungskette.svg" },
    { bezeichnung: "Handlungsempfehlung (Wenn-Dann)", datei: "/grafiken/M26-handlungsempfehlung.svg" },
  ],
  M17: [
  ...
  VA07: [
    ...
    { bezeichnung: "Umgang mit mehreren dringenden Anfragen", datei: "/grafiken/VA07-mehrfachanfragen.svg" },
  ],
  VA08: [
  ...
  TL03: [
    { bezeichnung: "Teamphasenuhr (Tuckman: Forming/Storming/Norming/Performing)", datei: "/grafiken/TL03-teamphasenuhr.svg" },
  ],
  TL04: [
  ...
  TL07: [
    { bezeichnung: "GROW-Coaching-Modell (Goal–Reality–Options–Will)", datei: "/grafiken/TL07-grow-modell.svg" },
  ],
  TL08: [
