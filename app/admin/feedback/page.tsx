        ...
        <section>
          ...
          <div className="bg-white border border-line overflow-hidden">
            <div className="overflow-x-auto">
              <div className="grid grid-cols-[70px_minmax(120px,1fr)_48px_100px_100px_100px_100px_100px] min-w-[700px] bg-primary text-white font-mono text-[10px] uppercase tracking-[0.08em]">
              ...
              {allModules.map((m, i) => {
                ...
                return (
                  <div
                    key={m.id}
                    className={`grid grid-cols-[70px_minmax(120px,1fr)_48px_100px_100px_100px_100px_100px] min-w-[700px] border-t border-line items-center ${i % 2 === 0 ? "bg-white" : "bg-bg-2"}`}
                  >
