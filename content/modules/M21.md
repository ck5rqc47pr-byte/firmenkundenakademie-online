...
### 4.1 Theorie-Input: Das 8-Felder-Framework für KMU-Kreditentscheidungen
...
M21 folgt Kolbs Erfahrungslernzyklus (Kolb, 1984): Teilnehmer werden mit einem realen Kreditfall konfrontiert (konkrete Erfahrung), reflektieren strukturiert gemeinsam (reflektierte Beobachtung), erarbeiten das 8-Felder-Analysemodell (abstrakte Begriffsbildung) und wenden es in Kleingruppen auf einen zweiten Fall an (aktives Experimentieren). Die Fallstudien sind bewusst mit Lücken und Ambivalenzen ausgestattet, um realitätsnahe Entscheidungssituationen zu simulieren.

**Maximale Teilnehmerzahl:** 12 Personen (bei mehr als 12 leidet die Qualität der Ergebnispräsentation).

### 3.2 Detaillierter Ablaufplan (240 Minuten)

| Zeit | Phase | Inhalt | Methode | Material |
|---|---|---|---|---|
| 08:00–08:10 | Einstieg | Begrüßung, Tagesagenda, Lernziele | Plenum | Agenda-Folie |
| 08:10–08:25 | Aktivierung | Blitzlicht: „Wann war Ihre letzte schwierige Kreditentscheidung – was hat sie schwierig gemacht?" | Rundgespräch | Flip-Chart |
| 08:25–09:00 | Theorie-Input I | Regulatorischer Rahmen (MaRisk BTO 1.1), Informationsasymmetrie, quantitativ vs. qualitativ | Vortrag + Diskussion | Foliensatz, Handout |
| 09:00–09:25 | Theorie-Input II | 8-Felder-Framework: Wiederholung und Anwendung auf Kreditvotierung; Entscheidungsbiases | Vortrag + Diskussion | Foliensatz |
| 09:25–09:30 | Überleitung | Fallstudien-Briefing, Gruppen bilden | Plenum | Fallstudienmappe |
| 09:30–10:15 | Fallstudienarbeit I | Einzelarbeit: Fallstudie analysieren, 8-Felder-Bogen und Votierungsbogen ausfüllen (45 min) | Einzelarbeit | AB-1, AB-2 |
| 10:15–10:25 | **Pause** | — | — | — |
| 10:25–10:55 | Fallstudienarbeit II | Gruppenarbeit (3er-Teams): Votierung diskutieren, Konditionierung kalkulieren | Kleingruppenarbeit | AB-3 |
| 10:55–11:25 | Präsentation | Jede Gruppe präsentiert Votum (5 min): Begründung, Risikofaktoren, Konditionen | Präsentation + Feedback | Flip-Chart |
| 11:25–11:45 | Musterlösung | Trainer präsentiert regulatorisch und bankwirtschaftlich korrekte Lösung, Abweichungen besprechen | Trainerinput | Musterlösung (Trainermappe) |
| 11:45–11:55 | Reflexion | „Was nehme ich mit? Was wende ich nächste Woche an?" – Transferaufgabe vorstellen | Plenum | AB-4 |
| 11:55–12:00 | Abschluss | Feedbackbogen ausfüllen, Hinweis auf M05/M06 | Plenum | Feedbackbogen |

> **Trainer-Hinweis Zeitplanung (P21-005):** Die 45 Minuten Einzelarbeitszeit sind bewusst so bemessen, dass Teilnehmer eine ernst gemeinte Analyse durchführen können. Die Fallstudie ist mit vorberechneten Kennzahlen aufgebaut – Teilnehmer müssen keine Rohdaten mühsam berechnen, sondern Interpretation und Bewertung vornehmen. Bei heterogenen Gruppen: Wer früher fertig ist, füllt bereits AB-2 (Votierungsbogen) aus.

### 3.3 Moderationshinweise und Regieanweisungen

**Aktivierungsphase (08:10–08:25)**
Stellen Sie die Frage offen, ohne Antworterwartung zu signalisieren. Notieren Sie Schlüsselbegriffe auf dem Flip-Chart – diese greifen Sie in der Theorieeinheit wieder auf. Bei Schweigen: 7-Sekunden-Regel anwenden, dann gezielt eine erfahrene Person ansprechen.

**Theorie-Input (08:25–09:25)**
Alle 15 Minuten eine Aktivierungsfrage einbauen: „Was kennen Sie davon aus der Praxis?" oder „Wie würden Sie das bei einem aktuellen Kunden einschätzen?". Teilnehmer mit Vorerfahrung aus M04 können das 8-Felder-Framework benennen – dieses Vorwissen explizit würdigen.

Umgang mit Kritik („Das machen wir anders"): „Gut, dass Sie das ansprechen. Schauen wir in der Fallstudie, ob Ihr Ansatz zu einem anderen Ergebnis führt."

**Einzelarbeit (09:30–10:00)**
Im Raum bewegen, beobachten, aber **nicht korrigierend eingreifen**. Unterschiedliche Bearbeitungstempi sind gewollt – einige werden in 15 Minuten fertig, andere arbeiten bis zum Schluss. Auf Fragen zur Fallstudie: „Arbeiten Sie mit den vorhandenen Informationen – das ist Bestandteil der Übung."

**Gruppenarbeit (10:15–10:45)**
Gruppen so zusammenstellen, dass je eine erfahrene und eine weniger erfahrene Person pro Gruppe sind. Bei Blockade: „Sie haben noch 10 Minuten. Treffen Sie eine Mehrheitsentscheidung und benennen Sie die Minderheitsmeinung explizit."

**Präsentation (10:45–11:15)**
Strikte Timebox (5 min/Gruppe). Bei übereinstimmenden Gruppenentscheidungen: „Interessant – alle kommen zum gleichen Ergebnis. Worin unterscheiden sich Ihre Begründungen?"

**Musterlösung (11:15–11:35)**
Die Musterlösung als „eine mögliche Entscheidung" präsentieren, nicht als die einzig richtige. Fachlich vertretbare Abweichungen explizit würdigen: „Ihre Argumentation für eine Ablehnung ist nachvollziehbar – die Musterlösung zeigt einen möglichen Genehmigungsweg mit Auflagen."

### 3.4 Benötigte Materialien

| Material | Anzahl | Hinweis |
|---|---|---|
| Fallstudienmappe (Fallstudie + Unternehmensdaten) | 12 × | Druck A4, einseitig |
| AB-1: 8-Felder-Analysebogen | 12 × | Aus Sec 4 |
| AB-2: Kreditvotierungsbogen | 12 × | Aus Sec 4 |
| AB-3: Konditionierungsblatt | 12 × | Aus Sec 4 |
| AB-4: Transferaufgabe | 12 × | Aus Sec 4 |
| Feedbackbogen (Kirkpatrick L1) | 12 × | Aus Sec 6 |
| Taschenrechner | 12 × | — |
| Flip-Chart (2 Stellwände) | 2 | Marker vorbereiten |
| Moderationskarten | 50 × | — |
| Trainermappe (Musterlösung, Ablaufplan) | 1 × | Nur für Trainer |
| Foliensatz auf Laptop/Beamer | 1 × | Beamer testen |

### 3.5 Trainer-Checkliste

> **Trainer-Hinweis:** Diese Checkliste verbleibt in der Trainermappe.

**Eine Woche vorher**
- [ ] Teilnehmerliste prüfen: Haben alle M02 und M04 absolviert?
- [ ] Bei fehlenden Voraussetzungen: Kurzwiederholung „8-Felder-Framework" versenden
- [ ] Fallstudienmappe drucken und binden
- [ ] Raumreservierung und Technik bestätigen

**Am Vortag**
- [ ] Alle Arbeitsblätter ausgedruckt (12 × je AB)
- [ ] Trainermappe mit Musterlösung griffbereit
- [ ] Gruppenaufteilung vorbereiten

**30 Minuten vor Beginn**
- [ ] Raum aufbauen (U-Form oder 3er-Gruppentische)
- [ ] Flip-Charts aufstellen, Marker testen
- [ ] Beamer und Foliensatz testen
- [ ] Taschenrechner auf Tische legen
- [ ] Namensschilder bereitlegen
...
*Die Lernerfolgsüberprüfung folgt dem Vier-Ebenen-Modell nach Kirkpatrick (1994): Reaktion (L1), Lernen (L2) und Verhalten (L3) werden direkt nach dem Workshop bzw. im nachgelagerten Arbeitsalltag erhoben.*

### 6.1 Kirkpatrick Level 1 – Reaktion: Feedbackbogen

**Modul M21 – Kreditentscheidung treffen**
*Benedikt Zoller Coaching | Datum: ____________ | Ort: ____________*

Bitte bewerten Sie die Aussagen auf einer Skala von 1 (trifft gar nicht zu) bis 5 (trifft voll zu).

| Nr. | Aussage | 1 | 2 | 3 | 4 | 5 |
|---|---|---|---|---|---|---|
| 1 | Die Lernziele des Moduls waren klar und nachvollziehbar. | | | | | |
| 2 | Der Theorie-Input war verständlich aufbereitet. | | | | | |
| 3 | Die Fallstudie war realistisch und praxisnah. | | | | | |
| 4 | Die Gruppenarbeit hat meinen Lernprozess unterstützt. | | | | | |
| 5 | Ich fühle mich nach dem Modul sicherer bei Kreditentscheidungen. | | | | | |
| 6 | Das 8-Felder-Framework ist ein nützliches Werkzeug für meinen Alltag. | | | | | |
| 7 | Die Zeitplanung war angemessen. | | | | | |
| 8 | Der Trainer hat die Inhalte kompetent vermittelt. | | | | | |
| 9 | Ich würde dieses Modul Kolleginnen und Kollegen empfehlen. | | | | | |
...
Welches Thema hätten Sie gerne vertieft?
______________________________
...
*Bitte kreuzen Sie die jeweils richtige Antwort an. Pro Frage gibt es genau eine richtige Antwort.*

**Frage 1:** Welche regulatorische Vorschrift verpflichtet zur Kreditwürdigkeitsprüfung vor der Kreditvergabe?

a) § 18 KWG (Offenlegungspflicht)
b) MaRisk BTO 1.1 (Kreditwürdigkeitsprüfung)
c) CRR Art. 124 (Risikogewichtung Immobilien)
d) MaRisk BTR 1 (Marktpreisrisiken)

**Frage 2:** Der Kapitaldienstdeckungsgrad (KDF) gibt an:

a) Das Verhältnis von Eigenkapital zu Fremdkapital
b) Den Anteil der Sicherheiten am Kreditvolumen
c) Das Verhältnis des freien Cashflows zum Kapitaldienst
d) Den Zinsaufwand im Verhältnis zum Umsatz

**Frage 3:** Welcher Mindestwert gilt typischerweise für den KDF bei einer Neukreditvergabe?

a) 0,80 b) 1,00 c) 1,20 d) 1,50

**Frage 4:** Was beschreibt die Informationsasymmetrie im Kreditgeschäft?

a) Banken wissen mehr als Kreditnehmer über ihre wirtschaftliche Lage
b) Kreditnehmer wissen mehr über ihre eigene Bonität als die Bank
c) Rating-Agenturen haben mehr Informationen als Banken
d) Große Banken wissen mehr als kleine Volksbanken

**Frage 5:** Im 8-Felder-Framework kann eine Genehmigung mit Auflagen trotz einer schwachen Einzelfeldbewertung (2/5) vertretbar sein, wenn:

a) Die Sicherheitendeckung über 100 % liegt
b) Das schwache Feld durch konkrete, SMART-formulierte Auflagen innerhalb der Kreditlaufzeit verbessert wird und der Gesamtscore ≥ 2,5 beträgt
c) Mindestens 6 Felder die Bewertung 4/5 oder besser haben
d) Markt und Marktfolge übereinstimmend positiv votieren

**Frage 6:** Ein Betrieb hat: JÜ 120 TEUR, AfA 80 TEUR, Entnahmen 90 TEUR, Erhaltungsinvestitionen 30 TEUR, Kapitaldienst 72 TEUR. Wie hoch ist der KDF?

a) 1,11 b) 1,25 c) 0,83 d) 1,39

**Frage 7:** Welcher Bias führt dazu, dass Berater bevorzugt Informationen suchen, die ihre Vorentscheidung bestätigen?

a) Overconfidence Bias b) Anchoring c) Confirmation Bias d) Halo-Effekt

**Frage 8:** Was ist gemäß MaRisk BTO 1.1 das primäre Entscheidungskriterium?

a) Sicherheitenwert b) Kapitaldienstfähigkeit aus laufenden Erträgen c) Schufa-Note d) Eigenkapitalquote
...
|---|---|---|
| 1 | b | MaRisk BTO 1.1 regelt die Kreditwürdigkeitsprüfung; § 18 KWG regelt Offenlegungspflichten |
| 2 | c | KDF = freier Cashflow ÷ Kapitaldienst |
| 3 | c | Branchenüblicher Mindestwert 1,20; 1,00–1,19 erfordert Auflagen |
| 4 | b | Kreditnehmer kennt seine Lage besser (Stiglitz & Weiss) |
| 5 | b | Ein 2/5-Feld (z. B. Kapitalstruktur) rechtfertigt keine automatische Ablehnung, wenn das Risiko durch konkrete Auflagen (z. B. EK-Thesaurierung) mitigierbar ist und der Gesamtscore ≥ 2,5 bleibt. Vgl. Fallbeispiel Schnell GmbH: Feld 3 = 2/5, Gesamtscore 3,30, Empfehlung „Zusage mit Auflagen" aufgrund der EK-Thesaurierungs-Auflage |
| 6 | a | (120+80–90–30) ÷ 72 = 80 ÷ 72 = 1,11 |
| 7 | c | Confirmation Bias: selektive Informationssuche zur Bestätigung von Vorannahmen |
| 8 | b | MaRisk BTO 1.1: KDF ist Primärkriterium; Sicherheiten sind Rückfallposition |

Auswertung: 7–8 richtig = Lernziele erreicht · 5–6 = überwiegend erreicht · unter 5 = Wiederholung empfohlen

---

### 6.3 Kirkpatrick Level 3 – Verhalten: Beobachtungskriterien (30-Tage-Check)

**Beobachtungsbogen für Führungskräfte | Modul M21 | Zeitraum: 30 Tage nach Seminar**

| Nr. | Beobachtungskriterium | Datum | Qualität (1–5) | Kommentar |
|---|---|---|---|---|
| 1 | Berater wendet das 8-Felder-Framework eigenständig bei Kreditvorlagen an | | | |
| 2 | Berater berechnet die KDF nachvollziehbar und dokumentiert sie | | | |
| 3 | Berater benennt qualitative Risikofaktoren explizit im Votum | | | |
| 4 | Berater empfiehlt risikoadäquate Auflagen bei grenzwertigen Engagements | | | |
| 5 | Berater erklärt sein Votum im Teamgespräch strukturiert | | | |
| 6 | Berater fordert fehlende Unterlagen nach § 18 KWG proaktiv an | | | |
| 7 | Berater zeigt kritische Distanz bei schwacher Bonität trotz Kundenbeziehung | | | |
| 8 | Berater leitet bei kritischen Engagements selbständig die Eskalation ein | | | |

Lernfortschritt sichtbar: Ja / Teilweise / Nein

Empfohlene Folgeschritte: ______________________________
