...
### Hinweise zur E-Learning-Vorbereitung

Die Teilnehmenden absolvieren vor dem Präsenztag verpflichtend ein 30-minütiges E-Learning-Modul. Dieses vermittelt die reinen Definitionsgrundlagen (IfM/EU-Definition, Größenklassen) und entlastet damit den Präsenztag von rein deklarativem Wissen.

**Vor dem Seminar prüfen:** Haben alle TN das E-Learning abgeschlossen? Erfahrungsgemäß haben in einer Gruppe von 12 Beratern 3–5 das E-Learning nicht absolviert – aus Zeitmangel, technischen Problemen oder weil die Erinnerung untergegangen ist.

> **Fallback-Plan (wenn mehr als 2 TN das E-Learning nicht gemacht haben):** Statt sofort in die Blitzlicht-Runde zu starten, 10-minütigen Kurzinput zur Begriffsklärung vorschalten: „KMU – was heißt das überhaupt?" (IfM-Definition, EU-Definition, je eine Folie). Das egalisiert den Wissensstand und spart Nachfragen. Die Wissensaktivierungsphase wird entsprechend um 5 Minuten verkürzt (Zeitpuffer).

**Teilnehmereinladung:** Das E-Learning 5–7 Tage vor dem Seminar ankündigen, konkrete Zeitangabe nennen (ca. 30 Min.), 48 Stunden vorher Erinnerung versenden. Bei technischen Hürden (VPN, Browser-Kompatibilität): Kontakt IT-Support als Ansprechpartner nennen.

**Benötigte Materialien:**
- Fallstudie Metallbau Fischer GmbH (1 je TN)
- Kennzahlenkarte 5-Fragen-Schema (laminiert oder ausgedruckt, 1 je TN)
- Analyse-Arbeitsblatt AB-1 (1 je TN)
- Flipchart mit vorbereiteter Risikofelder-Matrix
- Moderationskarten (3 Farben: grün/gelb/rot für Risikobewertung)

### Detaillierter Ablaufplan (Präsenz 90 Minuten)

| Zeit | Phase | Inhalt | Methode |
|------|-------|--------|---------|
| 00:00–00:05 | Begrüßung | Tagesziel, Bezug zum E-Learning | Plenum |
| 00:05–00:15 | Wissensaktivierung | Blitzlicht: "Was haben Sie im E-Learning mitgenommen?" | Reihum-Abfrage |
| 00:15–00:30 | Input KMU-Definitionen | IfM vs. EU, Förderrelevanz, Praxisbezug | Vortrag + Diskussion |
| 00:30–00:45 | Input Hausbank-Prinzip | Relationship Lending, Cross-Selling-Logik, Verbundpartner | Vortrag + Fragen |
| 00:45–01:15 | Fallarbeit Bergmann Holzmanufaktur | Einzelarbeit AB-1 (20 Min.) + Gruppenabgleich (10 Min.) | Einzel- + Gruppenarbeit |
| 01:15–01:30 | Plenumsdiskussion | Ergebnisse vorstellen, Risikofelder priorisieren | Moderierte Diskussion |
| 01:30–01:40 | Transfer & Abschluss | 5-Fragen-Schema in eigenen Kundenalltag übertragen | Plenum |

> **Trainer-Hinweis:** Gesamtdauer ca. 100 Minuten (Kernprogramm). Bei verfügbarer Zeit bis 120 Minuten: Aufgabe 4 (KK-Analyse) als Gruppenaufgabe vertiefen (10 Min. zusätzlich) oder Plenumsdiskussion auf alle Risikofelder ausdehnen.

### Moderationshinweise

**Wissensaktivierung:** Formulierung: *"Was hat Sie im E-Learning am meisten überrascht?"* Antworten stichwortartig festhalten. Ziel: Heterogenität des Vorwissens sichtbar machen.

**Input KMU-Definitionen:** Häufige Verwechslung beachten: Viele TN nehmen an, die EU-Definition sei "die richtige". Korrektive: Beide haben eigenständige Gültigkeit für unterschiedliche Verwendungszwecke.

**Input Hausbank-Prinzip:** Einstieg mit der Frage: *"Wie viele Ihrer Kunden würden Sie als echte Hausbankbeziehung bezeichnen?"* Petersen & Rajan (1994) als empirischen Beleg einsetzen.

**Fallarbeit:** Einzelarbeit (15 Min.) still, Trainer geht durch den Raum. Mindestens eine Gruppe sollte ihre Ergebnisse zu Risikofeld 1 (Inhaberabhängigkeit) und 2 (Nachfolge) vorstellen — hier liegt die didaktische Kernbotschaft.

### Erwartete Teilnehmerreaktionen

| Situation | Typische Reaktion | Empfohlener Umgang |
|-----------|------------------|--------------------|
| Verwechslung IfM/EU | "Ich dachte, bis 250 MA ist alles KMU" | Beide Definitionen nebeneinander visualisieren; Anwendungszweck betonen |
| Skepsis Hausbank | "Kunden gehen bei 0,1 % Zinsvorteil zur Direktbank" | Praxisantwort: *„Welcher eurer Kunden würde euch anrufen, wenn er nachts mit einem Liquiditätsproblem kämpft? Der Direktbank-Kunde ruft nicht an – der findet vielleicht nicht mal eine Servicenummer. Echte Hausbankbeziehungen überleben Zinsnachteile, weil sie auf Information und Vertrauen basieren, nicht auf Konditionen."* Das zieht in der Gruppe mehr als jede Quellenangabe. |
| Fallarbeit: Unterschätzung Inhaberrisiko | TN fokussieren auf EK-Quote | Nachfragen: "Was passiert mit dem Kredit, wenn Fischer morgen ausfällt?" |
| Widerstand Transferaufgabe | "Dafür fehlt die Zeit" | Aufwand realistisch: 15–20 Min. je Kunde; Mehrwert für Kreditqualität betonen |
...
**Modul M06 · KMU-Kompetenz Grundlagen · Benedikt Zoller Coaching**
...
|-----|---------|---|---|---|---|---|
| 1 | Die Inhalte waren für meinen Berufsalltag relevant. | | | | | |
| 2 | Der Praxisfall (Metallbau Fischer GmbH) hat mir geholfen, das Gelernte zu verstehen. | | | | | |
| 3 | Das 5-Fragen-Schema ist ein nützliches Werkzeug für meine Beratungsgespräche. | | | | | |
| 4 | Die Erklärungen des Trainers waren klar und verständlich. | | | | | |
| 5 | Das E-Learning hat mich gut auf den Präsenztag vorbereitet. | | | | | |
| 6 | Die Gruppenarbeit hat zum Lernerfolg beigetragen. | | | | | |
| 7 | Der zeitliche Rahmen des Seminars war angemessen. | | | | | |
| 8 | Ich würde dieses Modul einem Kollegen empfehlen. | | | | | |
...
**Zeitvorgabe: ca. 10 Minuten · ohne Hilfsmittel**

**Frage 1:** Welche Aussage zur IfM-KMU-Definition ist korrekt?

a) KMU nach IfM sind Unternehmen mit bis zu 250 Mitarbeitern.
b) Die IfM-Definition berücksichtigt die Einheit von Eigentum, Leitung und Haftung.
c) Die IfM-Definition ist für KfW-Förderanträge maßgeblich.
d) KMU nach IfM umfassen ausschließlich GmbHs.

**Frage 2:** Welche Definition ist für einen KfW-Förderantrag bindend?

a) IfM-Bonn-Definition  b) EU-Definition gemäß Empfehlung 2003/361/EG  c) HGB § 267  d) BaFin-Definition

**Frage 3:** Ein Unternehmen hat 45 Mitarbeiter, 8 Mio. EUR Jahresumsatz, 9 Mio. EUR Bilanzsumme. Welcher EU-Größenklasse entspricht es?

a) Kleinstunternehmen  b) Kleines Unternehmen  c) Mittleres Unternehmen  d) Großunternehmen

**Frage 4:** Nennen Sie zwei empirisch belegte Vorteile einer Hausbankbeziehung (Petersen & Rajan, 1994):

1. ______________________________
2. ______________________________

**Frage 5:** Thomas Fischer (58) führt seinen Betrieb allein, keine Nachfolgeregelung. Welches Risikofeld aus dem 5-Fragen-Schema ist am stärksten ausgeprägt? Begründen Sie in einem Satz.

______________________________

**Frage 6:** Ab welchem EK-Quoten-Niveau empfiehlt die Deutsche Bundesbank grundsätzlich erhöhte Aufmerksamkeit – **unabhängig von der Branche** (als erster Orientierungswert)?

a) Unter 25 %  b) Unter 20 %  c) Unter 15 %  d) Unter 10 %

> **Trainer-Hinweis (Musterlösungen):** F1: b | F2: b | F3: b | F4: Niedrigere Ausfallquoten + höhere Kreditverfügbarkeit (alternativ: Krisenresilienz, Zinsvorteil) | F5: Inhaberabhängigkeit — Fischer ist alleinige Führungsperson ohne Nachfolge | F6: c *(Wichtig: 15 % ist nur ein erster Orientierungswert – im Gespräch immer branchenrelativ interpretieren: Ein Handwerksbetrieb mit 15 % liegt ggf. im Branchenmittel; ein Maschinenbauer mit 15 % deutlich darunter. Das Modul lehrt den Branchenvergleich genau deshalb.)*

### Beobachtungskriterien für Führungskräfte (Kirkpatrick Level 3: Verhalten)

**Beobachtungszeitraum:** 4 Wochen nach Seminarteilnahme

| Nr. | Verhaltensanker | nie | gelegentlich | regelmäßig |
|-----|----------------|-----|--------------|------------|
| V-1 | Der/Die Berater/in ordnet KMU-Kunden korrekt nach IfM- oder EU-Definition ein und leitet daraus Handlungsschritte ab (z.B. KfW-Hinweis). | | | |
| V-2 | Inhaberabhängigkeit und Nachfolgethemen werden im Kundengespräch aktiv angesprochen. | | | |
| V-3 | Das 5-Fragen-Schema wird nachweislich zur Gesprächsvorbereitung genutzt (dokumentiert in agree21 oder CRM). | | | |
| V-4 | Verbundprodukte (R+V, Union Investment, Schwäbisch Hall) werden im Zusammenhang mit identifizierten Risikofeldern positioniert. | | | |
| V-5 | Die Hausbankbeziehung wird bei mindestens einem Kunden anhand der fünf Merkmale bewertet und eine Beratungsstrategie abgeleitet. | | | |
...
> **Trainer-Hinweis:** Beobachtungsformular unmittelbar nach dem Seminar mit kurzer mündlicher Einweisung an die Führungskraft übergeben. Befunde fließen in das Mitarbeitergespräch ein (Kirkpatrick, 1994, Level 3).
