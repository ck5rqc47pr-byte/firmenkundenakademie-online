...
Der Jahresabschluss beantwortet die Frage: „Wie ist die finanzielle Situation?" (Baetge, Kirsch & Thiele, 2019, S. 47). Diese Analyse ist die Grundlage des Kreditgeschäfts – und gleichzeitig nur die Hälfte der Geschichte.
...
- Branchenwert recherchieren (Deutsche Bundesbank, Unternehmensabschlussstatistik)
...
- Liquiditätsrisiko → Kontokorrent-Kreditlinie (VR-Bank)
- Zinsrisiko → Zinssicherungsinstrument (R+V)
...
|----------|------|---------|
| **Offene Explorationsfrage** | Kunden zum Erzählen bringen | „Wie erklären Sie sich den Rückgang der Liquiditätsreserve?" |
...
**Rolle A – Berater:** Führen Sie das Gespräch anhand des 5-Phasen-Rahmens. Primärziel: EK-Quote, Liquidität und Verschuldung verstehen und gemeinsam interpretieren. Sekundärziel: Beratungsimpulse ableiten (Zinssicherung R+V, Kontokorrent VR-Bank). Erst verstehen, dann empfehlen.

**Rolle B – GF Martin Klemm:** Einstiegsmodus: leicht angespannt. Bei belehrender Haltung: „Die Zahlen sehen schlechter aus als sie sind. Ich kenne mein Geschäft besser als jede Bilanz." Bei respektvollem Fragestil: progressiv öffnen und vom Großauftrag (1,2 Mio. EUR Vorlauffinanzierung), der CNC-Investition (400 TEUR) und der guten Auftragslage berichten.
...
**Reflexion nach dem Gespräch (agree CRM oder Notizbuch):**
